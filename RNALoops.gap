...
instance RNAmotiFold_subopt = gra_macrostate ((alg_motif * alg_mfe_subopt) * alg_motBracket); //run with -e 1.0 max, otherwise runtime gets very long and structure output very large