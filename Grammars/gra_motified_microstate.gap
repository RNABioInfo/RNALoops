...
//This is an alternative motified version of the MicroState grammar, where motifs can be found even if they only have a single base pair surrounding them.
...
//are the same as in the original MicroState grammar. Extension by Marius Sebeke, University of Stuttgart, 2025.

grammar gra_motified_microstate uses sig_foldrna(axiom = struct) {
